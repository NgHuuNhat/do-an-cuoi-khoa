        ...
        <div id='searchDemo' className='container'>
            <div className="search-demo custom-shadow grid grid-cols-12 smm:grid-cols-1 border-1 border-gray-300 md:rounded-full">
                ...
                <div className="search-block col-span-3 flex-1 p-3 flex justify-center items-center cursor-pointer relative gap-3">
                    ...
                    <div style={{backgroundColor: '#fe6b6e'}} className="search-w-100 w-12 h-12 bg-main   hover:bg-[#9e3e4e] duration-300 text-white rounded-full p-2 flex justify-center items-center">
