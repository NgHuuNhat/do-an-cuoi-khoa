...
export default function SearchDemo() {
    return (
        <div id='searchDemo' className='container'>
            <div className="custom-shadow grid grid-cols-12 smm:grid-cols-1 border-2 border-gray-300 md:rounded-full">
                ...
                <div className="col-span-3 flex-1 p-3 flex justify-center items-center cursor-pointer relative gap-3">
                    <p>Thêm khách</p>
                    <div style={{backgroundColor: '#fe6b6e'}} className="w-14 h-14 bg-main ml-5 hover:bg-[#9e3e4e] duration-300 text-white rounded-full p-2 flex justify-center items-center">
